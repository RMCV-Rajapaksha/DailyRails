...
<nav class="bg-white ">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <Link to="/map" type="button" class="text-white bg-primary  hover:bg-secondary focus:ring-4 focus:outline-none  font-medium rounded-sm text-sm px-4 py-2 text-center font-body">Map</Link>
